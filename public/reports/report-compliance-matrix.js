(function () {
  ...
  window.ReportRegistry["compliance-matrix"] = {
    ...
    description:
      "A multi-page grid view with vertical headers. Splits skills into groups of 10. Ordered by Rank, then Name.",
    params: [
      {
        key: "days",
    ...
    render: function (dataWrapper, uiConfig) {
      ...
      for (let i = 0; i < totalSkills; i += SKILLS_PER_PAGE) {
        ...
        const pageStyle =
          i > 0 ? "page-break-before: always; margin-top: 30px;" : "";
        ...
        rows.forEach((r, rowIndex) => {
          ...
          skillSlice.forEach((s) => {
            let cellStyle =
              "border:1px solid #ddd; text-align:center; padding:6px 2px;";
            let content = "";
