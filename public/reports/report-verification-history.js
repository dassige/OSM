(function() {
    ...
    window.ReportRegistry['verification-history'] = {
        ...
        description: "Log of online verification forms processed in the last 30 days.",
        ...
        render: function(dataWrapper, uiConfig) {
            ...
            if(data.length === 0) return html + "<tr><td colspan='6' style='text-align:center'>No activity recorded in the last 30 days.</td></tr></tbody></table>";
