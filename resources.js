const members = [
    { "name": "QFF Paulin, N M", "email": "", "skills": [] },
    { "name": "CFO Sweeting-Shaw, P J", "email": "", "skills": [] },
    { "name": "SFF Fouche, C D", "email": "", "skills": [] },
    { "name": "DCFO Milne, D S", "email": "", "skills": [] },
    { "name": "RFF Collins, S B", "email": "", "skills": [] },
    { "name": "FF Mason, J D", "email": "", "skills": [] },
    { "name": "FF Godfrey, D C", "email": "", "skills": [] },
    { "name": "FF Mollier-Alexander, C", "email": "", "skills": [] },
    { "name": "SFF Reilly, L B", "email": "", "skills": [] },
    { "name": "FF Fitzpatrick, R", "email": "", "skills": [] },
    { "name": "QFF Sparrow, M J", "email": "", "skills": [] },
    { "name": "OS-FF Iszard, A M", "email": "", "skills": [] },
    { "name": "SO Laloli, B J", "email": "", "skills": [] },
    { "name": "FF Hunter, W R", "email": "", "skills": [] },
    { "name": "RFF Hyde, C L", "email": "", "skills": [] },
    { "name": "RFF Walmsley, B G", "email": "", "skills": [] },
    { "name": "FF Crawley, P J", "email": "", "skills": [] },
    { "name": "OS-FF Sweeting-Shaw, B", "email": "", "skills": [] },
    { "name": "OS-FF Partington, A C", "email": "", "skills": [] }
];
